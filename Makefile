# This Makefile is for the JListbox extension to perl.
#
...
EXPORT_LIST = JListbox.def

PERL_ARCHIVE = $(PERL_INC)\perl56.lib

TO_INST_PM = JListbox.pm

PM_TO_BLIB = JListbox.pm \
	$(INST_LIBDIR)\JListbox.pm
...
JListbox.def: Makefile.PL
	$(PERL) "-I$(PERL_ARCHLIB)" "-I$(PERL_LIB)" -MExtUtils::Mksymlists \
     -e "Mksymlists('NAME' => 'JListbox', 'DLBASE' => '$(BASEEXT)', 'DL_FUNCS' => {  }, 'FUNCLIST' => [], 'IMPORTS' => {  }, 'DL_VARS' => []);"
...
realclean purge ::  clean
	...
	$(PERL) -I$(PERL_ARCHLIB) -I$(PERL_LIB) -MExtUtils::Command -e rm_f $(INST_LIBDIR)\JListbox.pm
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"JListbox\" VERSION=\",01,0,0\">\n}. qq{\t<TITLE>JListbox</TITLE>\n}. qq{\t<ABSTRACT></ABSTRACT>\n}. qq{\t<AUTHOR></AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"MSWin32-x86-multi-thread\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > JListbox.ppd
